...
![ib_signal_layer](./images/ib_signal_layer.png)

其实到这里就完成了一半需求了：有个容器View来管理一排子view。 现在在把目光放到IB的属性界面，来完成另一半
需求:

![ib_signal_attr](./images/ib_signal_attr.png)
...
![attr_demo_1](./images/attr_demo_1.png) ![attr_demo_2](./images/attr_demo_2.png)
...
![nested_design](./images/nested_design.png)
